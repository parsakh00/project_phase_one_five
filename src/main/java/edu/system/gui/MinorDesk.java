...
public class MinorDesk {
    ...
    public void sendMinorRequest() throws IOException, ParseException {
        ...
        MassageInNetwork sendMinor = new MassageInNetwork(getUsername(),getFacultyUser(),facultyName.getText());
    ...
    public String showResult() throws IOException, ParseException {
        ...
        MassageInNetwork howManyFacultyMinor = new MassageInNetwork(CurrentUser.getInstance().getUserName(),null,null);
